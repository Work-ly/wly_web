      ...
      <div className="h-screen w-screen bg-black text-sm">
        ...
        <div className="absolute w-screen h-max flex z-1">
          ...
          <div className='left w-1/2 flex flex-col justify-center'>
            <div className='w-full h-[calc(5% + 450px)] flex flex-col'>

              <div className='w-full flex flex-col items-center justify-center'>
                <p className='w-1/2 text-white'>Username:</p>
                <input className='w-1/2 h-12 rounded-lg p-2 transition-all duration-200 ease-in hover:rounded-md' type={"text"} placeholder='GuestUser0101'></input>
              </div>
              ...
              <button className='w-1/2 h-12 rounded-lg m-auto mt-10 bg-purple-secondary-dark text-white text-md transition-all duration-200
              ease-in hover:bg-dark hover:shadow-md'>Sign In</button>
              <div className='text-white text-xs m-auto '>
                <a href='/signup' className='underline decoration-solid'>Create an account instead</a>

              </div>

              <div className='w-1/2 mt-5 m-auto flex flex-row justify-center'>
                <button className='text-white w-8 h-8 rounded-full border-2 flex justify-center items-center mr-2' ><BsGithub /></button>
                <button className='text-white w-8 h-8 rounded-full border-2 flex justify-center items-center ml-2' ><BsGoogle /></button>
              </div>
